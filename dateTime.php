...
<dl>
    <dt>▲获取日期时间。date</dt>
    <dd>
        <?php date_default_timezone_set("Asia/Shanghai");//必要
    ...
    <dt>▲取得一个日期的Unix时间戳。mktime</dt>
    <dd><?php $t=mktime(9, 12, 31, 4, 19, 1993);//时分秒，月日年
        echo date("Y-m-d h:i:s", $t); ?>
    </dd>

    <dt>▲当前的Unix时间戳(单位:秒)。time</dt>
    <dd><?=time()?></dd>

    <dt>▲将英文日期时间解析为Unix时间戳。strtotime</dt>
    <dd><?php
